...
// import "react-datepicker/dist/react-datepicker.css";
// import { Form } from 'react-bootstrap';
// import { UseFormRegister, FieldValues, Path, FieldError, UseFormSetValue } from "react-hook-form"
...
// const DateInput = <T extends FieldValues>({ name, error, register, setValue } : DateInputProps<T>) => {
...
//             <DatePicker 
//                 onChange={(date: Date | null) => {
//                   setValue(name , date ?? undefined as any>);
//                 }}
//                 dateFormat="dd/MM/yyyy"
//                 className='custom-datepicker'
//                 placeholderText="Selecionar Dia"
